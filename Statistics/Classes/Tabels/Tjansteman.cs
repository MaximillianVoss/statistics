...
{
    public class Tjansteman : BaseTabel
    {
        #region Fields
        #endregion
        #region Methods
        ...
        private StatistikTabel AddCalculateColumns(StatistikTabel tabel, DataTable table, List<string> columnsNamesToAdd)
        {
            ...
            tabel.AddValue(Constants.ColumnNames.TimmarKomptid, timmar + odebiterade);
        ...
        public Tjansteman(String _name, List<String> columnNames)
        {
        ...
        public Tjansteman(String _name, int type, List<String> queryColumns, List<String> columnNames,
