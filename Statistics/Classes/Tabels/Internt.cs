...
{
    public class Internt :BaseTabel
    {
        #region Fields
        #endregion
        #region Methods
        ...
        private StatistikTabel AddCalculateColumns(StatistikTabel tabel, DataTable table, List<string> columnsNamesToAdd)
        {
            ...
            tabel.AddValue(Constants.ColumnNames.TimmarDebiterade, String.Empty);
            ...
            tabel.AddValue(Constants.ColumnNames.DebiteringBemanning, String.Empty);
        ...
        public Internt(String _name, List<String> columnNames)
        {
        ...
        public Internt(String _name, int type, List<String> queryColumns, List<String> columnNames,
